...
export function Home() {
  ...
  return (
    <>
      ...
      <main className="container max-w-5xl flex flex-col justify-center items-center">
        ...
        <div className=" text-white p-4 flex flex-col items-center space-y-6">
          ...
          <h3 className="text-2xl justify-center md:text-center marker:font-bold">
        ...
        <div className="container max-w-5xl  center flex-1 p-4  flex md:flex-row items-center center space-y-6 md:space-y-0 md:space-x-6">
         
          <div className="md:flex-row max-w-5xl px-8 sm:flex flex-col p-2 items-center bg-yellow-500">
            <div>
